...
<div class="card">
    <div class="card-header">
        <h2 style="text-align: center;">Payments Application</h2>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{url('/report/report1/' . $item->id)}}" title="Edit Payment"><button class="btn btn-success"><i class="fa fa-print" aria-hidden="true"></i>Print</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
